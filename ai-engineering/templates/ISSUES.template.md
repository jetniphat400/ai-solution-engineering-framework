...
audits" section for the ID-prefix, lane-rationale, and status
conventions — closing each finished item with one of `AGENTS.md`'s
terminal statuses directly — that keep such a register from colliding
with this one's numbering — not restated here.
